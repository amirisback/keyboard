object DependencyGradle {
    ...
    private const val FROGO_SDK_VERSION = "2.2.5"
    private const val FROGO_UI_VERSION = "2.0.1"
    private const val FROGO_CONSUME_API_VERSION = "2.5.2"
    private const val FROGO_ADMOB_VERSION = "5.3.5"
