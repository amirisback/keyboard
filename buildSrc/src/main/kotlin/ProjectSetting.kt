...
object ProjectSetting {
    ...
    const val PROJECT_TARGET_SDK = 36

    // ---------------------------------------------------------------------------------------------

    const val BASE_PACKAGE_NAME = "com.frogobox"

    const val MODULE_APP = "appkeyboard"
    const val MODULE_LIB_KEYBOARD = "libkeyboard"

    val APP_NAME = NAME_APP.lowercase().replace(" ", "")

    val PROJECT_APP_ID = "$APP_DOMAIN.$APP_PLAY_CONSOLE.$APP_NAME"

    const val PROJECT_NAME_SPACE_APP = "$BASE_PACKAGE_NAME.$MODULE_APP"
    const val PROJECT_NAME_SPACE_LIB_FROGO_KEYBOARD = "$BASE_PACKAGE_NAME.$MODULE_LIB_KEYBOARD"
